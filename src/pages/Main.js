        ...
        <>
            ...
            <Container  sx={{ py: 3 }}>
                ...
                <Box sx={{ width: '100%', typography: 'body1' }}>
                    <Typography sx={{fontSize:'30px',textAlign:'center',fontWeight:'bold'}}>Universities</Typography>
                            ...
                            return(
                                <Grid item key={index} lg={4} sm={6}  xs={12}  sx={{marginY:'20px'}}>
                                    <Card sx={{height:'100%',padding:'15px'}}>
                                            <Box sx={{display:'flex',alignContent:'center',gap:'10px',marginTop:'20px'}}>
                                                <GrGlobe />
                                                <Typography sx={{fontSize:'14px',fontWeight:'bold'}} gutterBottom variant="h5" component="div">
                                                    Country:  {items.country}
                                                </Typography>
                                            </Box>
                                            <Typography sx={{fontSize:'20px',marginY:'20px',fontWeight:'bold'}} variant="body2" color="text.secondary">
                                                {items.name}
                                            </Typography>
                                            ...
                                            <Box sx={{display:'flex',alignContent:'end',justifyContent:'space-between',}}>
                                                <Button sx={{fontWeight:'bold',borderRadius:'20px'}} variant="contained" onClick={()=>goTo(items.web_pages)}>Go to website</Button>
                                                <Button sx={{fontWeight:'bold',borderRadius:'20px'}} variant="contained" onClick={()=>goTo()}>{items.alpha_two_code}</Button>
                                            </Box>
                                    </Card>
                                </Grid>
